...
SECRET_KEY = os.environ.get('SECRET_KEY', 'django-insecure-*0rxzdmu+z1#&=8^!0asq$0rro5+tf=na7k&kbw4upq^@k*%t9')
...
# This will be automatically set by Heroku
...
if DATABASE_URL:
    ...
    DATABASES = {
        'default': {
            ...
            'NAME': os.environ.get('DB_NAME', 'healthmateai'),
...
CELERY_BEAT_SCHEDULE = {
    ...
    'update-completed-appointments': {
        'task': 'appointments.tasks.update_completed_appointments',
